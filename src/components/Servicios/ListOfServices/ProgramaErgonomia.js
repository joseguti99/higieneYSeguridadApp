        ...
        <div className='row justify-content-center'>
          ...
          <div className='col-11 col-lg-10'>
            <p className='description-ergonomia'>Según lo establecido en la Resolución MTESS Nº 295/03 Anexo I,
              se establece para los factores de riesgos ergonómicos la implementación
              ...
              <p className='description-ergonomia'>
                Definido el riesgo
                ergonómico por sus causales (agentes de riesgos) y por sus consecuencias
                sobre la salud (trastornos músculoesqueléticos), la Resolución 295/03
          ...
          <div className='col-12 col-lg-10'>
            <ul>
              ...
              <li className='li-ergonomia'>Evaluación de los trabajos con sospecha de posibles factores de riesgos.</li>
              ...
              <li className='li-ergonomia'>Cuidar adecuadamente de la salud para los trabajadores que tengan trastornos musculoesqueléticos.</li>
