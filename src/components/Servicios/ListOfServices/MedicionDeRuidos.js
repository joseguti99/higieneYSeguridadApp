        ...
        <div className='row'>
          ...
          <div className='col-12'>
            <p className='description-medicion'>El ruido es uno de los contaminantes laborales más comunes. 
              Gran cantidad de trabajadores se ven expuestos diariamente a 
            ...
            <p className='description-medicion'>Mediciones de ruidos molestos en la ciudad de Córdoba balo la Ordenanza 12208/13.</p>
          </div>
        </div>
      </div>
