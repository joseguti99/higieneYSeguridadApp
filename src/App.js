...
import ManualDeAutoproteccion from './components/Servicios/ListOfServices/ManualAutoProteccion';
    ...
    <div className="App">
      ...
      <NavBar/>
        <Routes>
          ...
          <Route exact={true} path="/servicios/Manual-de-Autoproteccion" element={<ManualDeAutoproteccion/>}/>
